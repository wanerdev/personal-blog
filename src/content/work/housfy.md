---
company: "Housfy"
role: "Full-Stack Developer | PHP | Laravel | VueJs"
...
- Design and development of robust APIs with Laravel, following DDD and Hexagonal Architecture.

- Implementation and consumption of third party APIs, optimizing external integrations.

- Writing unit tests to ensure code quality and reliability.

- Database management, ensuring performance and consistency of information.

- Maintenance and refactoring of existing code, along with new implementations adapted to specific requirements.
